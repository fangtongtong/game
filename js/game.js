...
person.prototype={
    draw:function(){
        ...
        this.cobj.drawImage(this[this.status][this.state],0,0,1200,800,0,0,this.width,this.height);
        this.cobj.restore();
    }
};
...
hinder.prototype={
    draw:function(){
        this.cobj.save();
        this.cobj.translate(this.x,this.y);
        this.cobj.drawImage(this.hinderImg[this.state],0,0,400,350,0,0,this.width,this.height);
        this.cobj.restore();
    }
}
//血
